...
CLauncher-linux-x64.tar.gz — Linux (стабильная, семейство Ubuntu/Debian, нужны зависимости ниже).

CLauncher-x86_64.AppImage — Linux (любой дистрибутив с glibc 2.35+; скачайте, сделайте исполняемым, запустите).

CLauncher-beta.exe — Windows 10/11 (бета, ещё не проверена на реальной Windows).
